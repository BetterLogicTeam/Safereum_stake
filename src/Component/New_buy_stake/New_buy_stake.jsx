...
export default function New_buy_stake() {
  return (
    ...
    <div className="conatiner text-center">
        <h1 className='site_font main_interation'>The future of social interaction</h1>
        <p className='site_font'>Refer your friend and your favorite co creators to join the tip coin compelition and get reward in tip coin</p>
